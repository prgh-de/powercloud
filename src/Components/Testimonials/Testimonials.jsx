            ...
            <div className={style.box}>
                <div className={style.container}>
                    ...
                    <Carousel>
                        ...
                        <br/><br/><br/>
                            <div className={style.person}>"Karsten Wildberger, COO Commercials E.ON SE"</div></p>
                        <p className={style.customer}>
                        ...
                        <p className={style.customer}>
                            ...
                            <br/><br/><br/>
                            <div className={style.person}>Jens Kallrath, Head of Business IT Customer Solutions, E.ON Energie Deutschland</div></p>
                        <p className={style.customer}>
